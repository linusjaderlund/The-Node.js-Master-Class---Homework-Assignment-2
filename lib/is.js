...
/**
 * Method to determine if input is defined
 * @param {any} input
 * @return {boolean} Returns true is input is defined
 */
is.defined = (input) => {
...
/**
 * Method to determine if input is NOT an array or not
 * @param {any} input
 * @return {boolean} Returns true if input is NOT an array
 */
is.notArray = (input) => {
  return !Array.isArray(input);
};
