 ...
 * @return {undefined}
 */
const handleAction = (api, data, callback, ...protectedMethods) => {
...
handlers.user = (data, callback) => {
  handleAction(user, data, callback, 'get', 'put', 'delete');
};
...
handlers.pizza = (data, callback) => {
  handleAction(pizza, data, callback, 'post', 'get', 'put', 'delete');
};
...
handlers.cart = (data, callback) => {
  handleAction(cart, data, callback, 'post', 'get', 'put', 'delete');
};
...
handlers.token = (data, callback) => {
  handleAction(token, data, callback);
};
